...
const Preferences = () => {
    ...
    const { preferences: initialPreferences, updatePreferences, isUpdating } = usePreferences();

    const [localPrefs, setLocalPrefs] = useState(initialPreferences || DEFAULT_PREFERENCES);
        ...
        <Box sx={classes.container}>
            <Box sx={classes.header}>
                ...
                <Fade in={showSaved || isUpdating}>
                    <Box sx={{ ml: "auto" }}>
                        <Alert severity="success" icon={false} sx={{ py: 0, px: 1, fontSize: "0.75rem", minWidth: 60 }}>
            ...
            <Box sx={classes.sectionCard}>
                ...
                <FormControl variant="outlined" size="small" sx={classes.select}>
                    <Select
                        ...
                        onChange={(e) => handlePreferenceChange({ units: e.target.value as string })}
                    >
            ...
            <Box sx={classes.sectionCard}>
                ...
                <FormControl variant="outlined" size="small" sx={classes.select}>
                    <Select
                        ...
                        onChange={(e) => handlePreferenceChange({ weeklyGoal: Number(e.target.value) })}
                    >
